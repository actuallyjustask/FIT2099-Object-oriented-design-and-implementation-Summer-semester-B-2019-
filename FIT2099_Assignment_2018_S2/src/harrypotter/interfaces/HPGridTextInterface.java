...
public class HPGridTextInterface implements GridRenderer {
	...
	public int getStringSelection(ArrayList<String> choices) {
		
		//assertion for the precondition
		assert choices.size()>0:"there are no choices";
		...
		int selection = 0; //set to zero to trigger the loop
		while (selection < 1 || selection > choices.size()) {//loop until a valid command has been obtained
			System.out.println("Enter command:");
		...
		return selection-1;//return the action selected		
	}
