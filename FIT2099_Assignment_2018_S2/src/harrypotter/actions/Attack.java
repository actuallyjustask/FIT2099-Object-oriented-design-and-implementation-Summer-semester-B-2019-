...
import harrypotter.entities.actors.Dementor;
...
public class Attack extends HPAffordance implements HPActionInterface {
	...
	public void act(HPActor a) {
		...
		if (targetIsActor && (a.getTeam() == targetActor.getTeam())) { //don't attack HPActors in the same team
			...
			} else if (a instanceof Dementor) {
				target.takeDamage(Dementor.ATTACK_DAMAGE); // dementor attacks deal a specified amount of damage, and don't use energy
			}
