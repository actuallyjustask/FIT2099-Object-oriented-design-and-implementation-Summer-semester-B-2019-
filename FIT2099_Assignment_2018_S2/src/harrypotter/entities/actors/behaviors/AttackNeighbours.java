...
public class AttackNeighbours {
	...
	public static AttackInformation attackLocals(HPActor actor, HPWorld world, boolean avoidFriendlies, boolean avoidNonActors) {
		ArrayList<AttackInformation> attackables = getAttackables(actor, world, avoidFriendlies, avoidNonActors);
	...
	public static ArrayList<AttackInformation> getAttackables(HPActor actor, HPWorld world, boolean avoidFriendlies, boolean avoidNonActors) {
